...
(async () => {
  ...
  await page.goto('https://8080-deaadabecbcaddfcbdbdfaeecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-deaadabecbcaddfcbdbdfaeecdcaceefaffcabd.ide.exam.ly');
